...
const branches = ["Branch A", "Branch B", "Branch C", "Branch D","Branch E"]; // Replace with actual branch data
...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        setBranch(userInfo.branch) // Assuming branch is a part of userInfo
    }, [userInfo.email, userInfo.username, userInfo.branch])
    ...
    const submitHandler = async (e) => {
        ...
        if (password !== confirmedPassword) {
            ...
            try {
                const res = await updateProfile({ _id: userInfo._id, username, email, password, branch }).unwrap()
        ...
        <div className='container mx-auto p-4 mt-[10rem]'>
            <div className="flex justify-center align-center md:flex md:space-x-4">
                <div className="md:w-1/3">
                    <h2 className="h2 text 2xl font-semibold mb-4">Update Profile</h2>

                    <form onSubmit={submitHandler}>
                        <div className="mb-4">
                            <label htmlFor='' className='black text-gray mb-2'>
                                Name
                            </label>
                        ...
                        <div className="mb-4">
                            ...
                            <input type='password' placeholder='Enter Password' className='form-input p-4 rounded-sm w-full' value={confirmedPassword} onChange={e => setConfirmedPassword(e.target.value)} />
                        </div>
                        <div className="mb-4">
                            <label htmlFor='' className='black text-gray mb-2'>
                                Branch
                            </label>
                            <select className='form-select p-4 rounded-sm w-full text-black' value={branch} onChange={e => setBranch(e.target.value)}>
